...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_104 = Integer(104); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_500 = Integer(500); _sage_const_31 = Integer(31); _sage_const_28 = Integer(28); _sage_const_29 = Integer(29); _sage_const_22 = Integer(22); _sage_const_23 = Integer(23); _sage_const_20 = Integer(20); _sage_const_21 = Integer(21); _sage_const_26 = Integer(26); _sage_const_27 = Integer(27); _sage_const_9999 = Integer(9999); _sage_const_25 = Integer(25); _sage_const_136 = Integer(136); _sage_const_62 = Integer(62); _sage_const_37 = Integer(37); _sage_const_85 = Integer(85); _sage_const_87 = Integer(87); _sage_const_33 = Integer(33); _sage_const_24 = Integer(24); _sage_const_32 = Integer(32); _sage_const_13 = Integer(13); _sage_const_12 = Integer(12); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_17 = Integer(17); _sage_const_16 = Integer(16); _sage_const_59 = Integer(59); _sage_const_14 = Integer(14); _sage_const_57 = Integer(57); _sage_const_30 = Integer(30); _sage_const_19 = Integer(19); _sage_const_18 = Integer(18); _sage_const_15 = Integer(15); _sage_const_34 = Integer(34); _sage_const_51 = Integer(51); _sage_const_36 = Integer(36); _sage_const_39 = Integer(39); _sage_const_99 = Integer(99); _sage_const_76 = Integer(76); _sage_const_71 = Integer(71); _sage_const_73 = Integer(73); _sage_const_38 = Integer(38); _sage_const_101 = Integer(101); _sage_const_90 = Integer(90); _sage_const_35 = Integer(35)## This file (simplifyNumericLogs-Practice1.sagetex.sage) was *autogenerated* from simplifyNumericLogs-Practice1.tex with sagetex.sty version 2015/08/26 v3.0-92d9f7a.
import sagetex
...
try:
 ...
 while p1arg1 > _sage_const_500 :
     p1pwr1 = RandInt(_sage_const_1 ,_sage_const_5 )
     p1arg1 = p1b1**p1pwr1
     p1arg2 = p1b1**(-p1pwr1)
 p1ans1 = p1pwr1
 p1ans2 = -p1pwr1
 ...
 while p2arg1 > _sage_const_500 :
     p2pwr1 = RandInt(_sage_const_1 ,_sage_const_5 )
     p2arg1 = p2b1**p2pwr1
     p2arg2 = p2b1**(-p2pwr1)
 p2ans1 = p2pwr1
 p2ans2 = -p2pwr1
 ...
 while p3arg1 > _sage_const_500 :
     p3pwr1 = RandInt(_sage_const_1 ,_sage_const_5 )
     p3arg1 = p3b1**p3pwr1
     p3arg2 = p3b1**(-p3pwr1)
 p3ans1 = p3pwr1
 p3ans2 = -p3pwr1
...
try:
 _st_.current_tex_line = _sage_const_62 
 _st_.inline(_sage_const_7 , latex(p1arg1))
except:
 _st_.goboom(_sage_const_62 )
try:
 _st_.current_tex_line = _sage_const_62 
...
try:
 _st_.current_tex_line = _sage_const_62 
 _st_.inline(_sage_const_9 , latex(p1arg1))
except:
 _st_.goboom(_sage_const_62 )
try:
...
try:
 _st_.current_tex_line = _sage_const_71 
 _st_.inline(_sage_const_11 , latex(p2arg1))
except:
 _st_.goboom(_sage_const_71 )
try:
 _st_.current_tex_line = _sage_const_71 
...
try:
 ...
 _st_.inline(_sage_const_13 , latex(p2b1))
except:
 _st_.goboom(_sage_const_73 )
try:
 _st_.current_tex_line = _sage_const_73 
 _st_.inline(_sage_const_14 , latex(p2arg2))
except:
 _st_.goboom(_sage_const_73 )
try:
 _st_.current_tex_line = _sage_const_73 
 _st_.inline(_sage_const_15 , latex(p2ans2))
except:
 _st_.goboom(_sage_const_73 )
try:
 _st_.current_tex_line = _sage_const_76 
 _st_.inline(_sage_const_16 , latex(p2b1))
except:
 _st_.goboom(_sage_const_76 )
try:
 _st_.current_tex_line = _sage_const_76 
 _st_.inline(_sage_const_17 , latex(p2arg1))
except:
 _st_.goboom(_sage_const_76 )
try:
 _st_.current_tex_line = _sage_const_76 
...
try:
 _st_.current_tex_line = _sage_const_76 
 _st_.inline(_sage_const_19 , latex(p2arg1))
except:
 _st_.goboom(_sage_const_76 )
try:
...
try:
 _st_.current_tex_line = _sage_const_85 
 _st_.inline(_sage_const_21 , latex(p3arg1))
except:
 _st_.goboom(_sage_const_85 )
try:
 _st_.current_tex_line = _sage_const_85 
...
try:
 ...
 _st_.inline(_sage_const_23 , latex(p3b1))
except:
 _st_.goboom(_sage_const_87 )
try:
 _st_.current_tex_line = _sage_const_87 
 _st_.inline(_sage_const_24 , latex(p3arg2))
except:
 _st_.goboom(_sage_const_87 )
try:
 _st_.current_tex_line = _sage_const_87 
 _st_.inline(_sage_const_25 , latex(p3ans2))
except:
 _st_.goboom(_sage_const_87 )
try:
 _st_.current_tex_line = _sage_const_90 
 _st_.inline(_sage_const_26 , latex(p3b1))
except:
 _st_.goboom(_sage_const_90 )
try:
 _st_.current_tex_line = _sage_const_90 
 _st_.inline(_sage_const_27 , latex(p3arg1))
except:
 _st_.goboom(_sage_const_90 )
try:
 _st_.current_tex_line = _sage_const_90 
...
try:
 _st_.current_tex_line = _sage_const_90 
 _st_.inline(_sage_const_29 , latex(p3arg1))
except:
 _st_.goboom(_sage_const_90 )
try:
...
try:
 _st_.current_tex_line = _sage_const_99 
 _st_.inline(_sage_const_31 , latex(p4arg1))
except:
 _st_.goboom(_sage_const_99 )
try:
 _st_.current_tex_line = _sage_const_99 
...
try:
 ...
 _st_.inline(_sage_const_33 , latex(p4b1))
except:
 _st_.goboom(_sage_const_101 )
try:
 _st_.current_tex_line = _sage_const_101 
 _st_.inline(_sage_const_34 , latex(p4arg2))
except:
 _st_.goboom(_sage_const_101 )
try:
 _st_.current_tex_line = _sage_const_101 
...
try:
 _st_.current_tex_line = _sage_const_104 
 _st_.inline(_sage_const_37 , latex(p4arg1))
except:
 _st_.goboom(_sage_const_104 )
try:
 _st_.current_tex_line = _sage_const_104 
...
try:
 _st_.current_tex_line = _sage_const_104 
 _st_.inline(_sage_const_39 , latex(p4arg1))
except:
 _st_.goboom(_sage_const_104 )
_st_.endofdoc()
