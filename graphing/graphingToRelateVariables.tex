...
\begin{problem}
    ...
    \begin{selectAll}
        \choice[correct]{Large-scale information}
        \choice{Precise information}
        \choice[correct]{Big picture trends and patterns.}
        \choice{Specific point values and locations.}
        \choice{Nothing. Absolutely nothing.}
    \end{selectAll}
\end{problem}
