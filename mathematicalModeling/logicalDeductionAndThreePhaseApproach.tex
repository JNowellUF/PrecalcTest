...
\subsubsection*{Is that it?}
    ...
    \begin{problem}
        What is the point of the first phase of modeling? (Select all that apply)
        \begin{selectAll}
            \choice[correct]{To clarify what is actually being asked.}
            \choice{To get all the necessary numbers and quantities you need to solve the problem.}
            \choice[correct]{To determine what aspects/criteria may not have been left out of the initial problem statement.}
            \choice{To annoy your boss with endless questions.}
            \choice[correct]{To begin the process of narrowing the problem down to quantifiable precise criteria.}
        \end{selectAll}
    \end{problem}


    \begin{problem}
        What is the point of the second phase of modeling? (Select all that apply)
        \begin{selectAll}
            \choice{To come up with some kind of numeric value that represents the answer.}
            \choice[correct]{To get all the necessary numbers and quantities you need to solve the problem.}
            \choice[correct]{To determine how the various quantifiable criteria are related to each other.}
            \choice{To write down all the numbers you have until something fits.}
            \choice{To impress your boss with a bunch of smart looking math so they don't ask questions.}
        \end{selectAll}
    \end{problem}
    ...
    \begin{problem}
        What is the point of the third phase of modeling? (Select all that apply)
        \begin{selectAll}
            \choice[correct]{To come up with some kind of numeric value that represents the answer.}
            \choice{To get all the necessary numbers and quantities you need to solve the problem.}
            \choice{To boil everything down to a single simple relationship that gives an answer.}
            \choice{To write down all the numbers you have until something fits.}
            \choice{To impress your boss with a bunch of smart looking math so they don't ask questions.}
        \end{selectAll}
    \end{problem}
    ...
    \begin{problem}
        If you cannot get a numeric answer after going through these three phases of modeling, what does that mean? (Select all that apply)
        \begin{selectAll}
            \choice{That you messed something up. This always works.}
            \choice[correct]{The problem you are working on may not be a quantifiable question.}
            \choice[correct]{You may not have all the quantities/criteria you need; so you may need to start over at phase one to clarify further.}
            \choice{That you should just write down your best guess and hope nobody askes too many questions.}
        \end{selectAll}
    \end{problem}
