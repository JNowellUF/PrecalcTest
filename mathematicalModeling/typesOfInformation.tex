...
\begin{problem}
    ...
    \begin{multipleChoice}
        \choice{In the real world, only information that can be boiled down to an effect on a bottom line; ie numbers, are important.}
        \choice{The only thing we know how to deal with in science is numbers.}
        \choice[correct]{This is a math course which focuses around algebra and numbers; other courses focus on other types of information as appropriate.}
        \choice{This is a math class, and math is only about numbers.}
        \choice{Because the education gods hate me and have decided this is the best way to tortue me.}
    \end{multipleChoice}
\end{problem}
...
\begin{problem}
    ...
    \begin{selectAll}
        \choice{It's not. By definition.}
        \choice[correct]{Because knowing what information to not include can actually dramatically simplify a problem.}
        \choice[correct]{In the real world you just about always get random information that isn't useful. Weeding out that information is an important skill.}
        \choice{Because that is the information we will use to solve the problem.}
        \choice[correct]{Often identifying what is or isn't extraneous is the hard part of a problem.}
    \end{selectAll}
\end{problem}
