...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_88 = Integer(88); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_100 = Integer(100); _sage_const_9 = Integer(9); _sage_const_90 = Integer(90); _sage_const_83 = Integer(83); _sage_const_200 = Integer(200); _sage_const_10 = Integer(10); _sage_const_50 = Integer(50)## This file (solvingUnsimplifiedRadicals-Practice1.sagetex.sage) was *autogenerated* from solvingUnsimplifiedRadicals-Practice1.tex with sagetex.sty version 2015/08/26 v3.0-92d9f7a.
import sagetex
